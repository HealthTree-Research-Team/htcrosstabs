...
#' @export
add_numeric_table <- function(ct, round_mean_sd_to = ROUND_MEAN_SD_TO, round_med_iqr_to = ROUND_MED_IQR_TO) {
    validate_input_add_numeric_table(ct, round_mean_sd_to, round_med_iqr_to)
    ct |>
        add_total_row() |>
...
add_default_table <- function(ct, keep_na_vars = F, round_mean_sd_to = ROUND_MEAN_SD_TO, round_med_iqr_to = ROUND_MED_IQR_TO, round_percent_to = ROUND_PERCENT_TO) {
    validate_input_add_default_table(ct, keep_na_vars, round_mean_sd_to, round_med_iqr_to, round_percent_to)
